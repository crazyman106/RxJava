 ...
 * <p>
 * When a {@code MaybeObserver} is subscribed to a {@link io.reactivex.MaybeSource} through the {@link MaybeSource#subscribe(MaybeObserver)} method,
...
public interface MaybeObserver<T> {
    ...
    /**
     * Notifies the MaybeObserver with one item and that the {@link io.reactivex.Maybe} has finished sending
     * push-based notifications.
     * <p>
     * The {@link io.reactivex.Maybe} will not call this method if it calls {@link #onError}.
     *
     * @param t
    ...
    /**
     * Notifies the MaybeObserver that the {@link io.reactivex.Maybe} has experienced an error condition.
     * <p>
