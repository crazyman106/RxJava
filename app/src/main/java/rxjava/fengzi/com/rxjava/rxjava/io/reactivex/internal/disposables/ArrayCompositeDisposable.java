...
public final class ArrayCompositeDisposable extends AtomicReferenceArray<Disposable> implements Disposable {
    ...
    public boolean setResource(int index, Disposable resource) {
        for (;;) {
            ...
            if (o == io.reactivex.internal.disposables.DisposableHelper.DISPOSED) {
                resource.dispose();
                return false;
            }
    ...
    public void dispose() {
        if (get(0) != io.reactivex.internal.disposables.DisposableHelper.DISPOSED) {
            ...
            for (int i = 0; i < s; i++) {
                Disposable o = get(i);
                if (o != io.reactivex.internal.disposables.DisposableHelper.DISPOSED) {
                    o = getAndSet(i, io.reactivex.internal.disposables.DisposableHelper.DISPOSED);
                    if (o != io.reactivex.internal.disposables.DisposableHelper.DISPOSED && o != null) {
                        o.dispose();
                    }
                }
            }
