...
import rxjava.fengzi.com.rxjava.rxjava.io.reactivex.internal.operators.completable.CompletableAmb;
import rxjava.fengzi.com.rxjava.rxjava.io.reactivex.internal.operators.completable.CompletableEmpty;
import rxjava.fengzi.com.rxjava.rxjava.io.reactivex.observers.DisposableCompletableObserver;
import rxjava.fengzi.com.rxjava.rxjava.io.reactivex.plugins.RxJavaPlugins;
import rxjava.fengzi.com.rxjava.rxjava.io.reactivex.subjects.CompletableSubject;
 ...
 * {@link CompletableSubject CompletableSubject}.
 * <p>
 ...
 * {@link DisposableCompletableObserver DisposableCompletableObserver} instance.
 ...
 *
 * @see DisposableCompletableObserver
 */
public abstract class Completable implements CompletableSource {
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code complete} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code unsafeCreate} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code fromAction} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code fromMaybe} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code fromRunnable} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     * @param run the runnable to run for each subscriber
     * @return the new Completable instance
     * @throws NullPointerException if run is null
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code fromObservable} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code fromSingle} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     ...
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code merge0} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     * @param sources the iterable sequence of sources.
     * @param maxConcurrency the maximum number of concurrent subscriptions
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code timer} does operate by default on the {@code computation} {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code timer} operates on the {@link io.reactivex.Scheduler} you specify.</dd>
     * </dl>
     * @param delay the delay time
     * @param unit the delay unit
    ...
    public static Completable timer(final long delay, final TimeUnit unit, final io.reactivex.Scheduler scheduler) {
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code andThen} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <T> io.reactivex.Observable<T> andThen(ObservableSource<T> next) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <T> io.reactivex.Flowable<T> andThen(Publisher<T> next) {
        ObjectHelper.requireNonNull(next, "next is null");
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <T> io.reactivex.Single<T> andThen(SingleSource<T> next) {
        ObjectHelper.requireNonNull(next, "next is null");
        return RxJavaPlugins.onAssembly(new SingleDelayWithCompletable<T>(next, this));
    }

    /**
     * Returns a {@link io.reactivex.Maybe} which will subscribe to this Completable and once that is completed then
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <T> io.reactivex.Maybe<T> andThen(MaybeSource<T> next) {
        ObjectHelper.requireNonNull(next, "next is null");
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code blockingAwait} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     *  <dt><b>Error handling:</b></dt>
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code blockingGet} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code delay} does operate by default on the {@code computation} {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     * @param delay the delay time
     * @param unit the delay unit
     * @return the new Completable instance
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code delay} operates on the {@link io.reactivex.Scheduler} you specify.</dd>
     * </dl>
     * @param delay the delay time
     * @param unit the delay unit
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Completable delay(long delay, TimeUnit unit, io.reactivex.Scheduler scheduler) {
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Completable delay(final long delay, final TimeUnit unit, final io.reactivex.Scheduler scheduler, final boolean delayError) {
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @Experimental
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Completable delaySubscription(long delay, TimeUnit unit, io.reactivex.Scheduler scheduler) {
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code doOnEvent} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     ...
     * @see io.reactivex.Single#dematerialize(Function)
     */
    @Experimental
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <T> io.reactivex.Single<Notification<T>> materialize() {
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code observeOn} operates on a {@link io.reactivex.Scheduler} you specify.</dd>
     * </dl>
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Completable observeOn(final io.reactivex.Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code onErrorComplete} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     * @return the new Completable instance
     */
    @CheckReturnValue
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Completable repeatWhen(Function<? super io.reactivex.Flowable<Object>, ? extends Publisher<?>> handler) {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final Completable retryWhen(Function<? super io.reactivex.Flowable<Throwable>, ? extends Publisher<?>> handler) {
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <T> io.reactivex.Observable<T> startWith(io.reactivex.Observable<T> other) {
        ObjectHelper.requireNonNull(other, "other is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <T> io.reactivex.Flowable<T> startWith(Publisher<T> other) {
        ObjectHelper.requireNonNull(other, "other is null");
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code subscribeOn} operates on a {@link io.reactivex.Scheduler} you specify.</dd>
     * </dl>
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Completable subscribeOn(final io.reactivex.Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code timeout} signals the TimeoutException on the {@code computation} {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     * @param timeout the timeout value
     * @param unit the timeout unit
     * @return the new Completable instance
     ...
     *  the {@code computation} {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     * @param timeout the timeout value
     * @param unit the timeout unit
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code timeout} signals the TimeoutException on the {@link io.reactivex.Scheduler} you specify.</dd>
     * </dl>
     * @param timeout the timeout value
     * @param unit the timeout unit
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Completable timeout(long timeout, TimeUnit unit, io.reactivex.Scheduler scheduler) {
     ...
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code timeout} subscribes to the other CompletableSource on
     *  the {@link io.reactivex.Scheduler} you specify.</dd>
     * </dl>
     * @param timeout the timeout value
     * @param unit the timeout unit
     * @param scheduler the scheduler to use to wait for completion
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Completable timeout(long timeout, TimeUnit unit, io.reactivex.Scheduler scheduler, CompletableSource other) {
        ObjectHelper.requireNonNull(other, "other is null");
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>You specify the {@link io.reactivex.Scheduler} this operator runs on.</dd>
     * </dl>
     * @param timeout the timeout value
     * @param unit the timeout unit
     * @param scheduler the scheduler to use to wait for completion
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    private Completable timeout0(long timeout, TimeUnit unit, io.reactivex.Scheduler scheduler, CompletableSource other) {
        ObjectHelper.requireNonNull(unit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    /**
     * Converts this Completable into a {@link io.reactivex.Maybe}.
     * <p>
     * <img width="640" height="585" src="https://raw.github.com/wiki/ReactiveX/RxJava/images/rx-operators/Completable.toMaybe.png" alt="">
     * <dl>
     * <dt><b>Scheduler:</b></dt>
     * <dd>{@code toMaybe} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     *
     * @param <T> the value type
     * @return a {@link io.reactivex.Maybe} that only calls {@code onComplete} or {@code onError}, based on which one is
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code toObservable} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     * @param <T> the value type
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code toSingle} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     * @param <T> the value type
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <T> io.reactivex.Single<T> toSingle(final Callable<? extends T> completionValueSupplier) {
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code toSingleDefault} does not operate by default on a particular {@link io.reactivex.Scheduler}.</dd>
     * </dl>
     * @param <T> the value type
     ...
     * <dl>
     *  <dt><b>Scheduler:</b></dt>
     *  <dd>{@code unsubscribeOn} calls dispose() of the upstream on the {@link io.reactivex.Scheduler} you specify.</dd>
     * </dl>
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.CUSTOM)
    public final Completable unsubscribeOn(final io.reactivex.Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
