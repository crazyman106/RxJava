...
package rxjava.fengzi.com.rxjava.rxjava.io.reactivex.internal.subscriptions;
...
public final class ArrayCompositeSubscription extends AtomicReferenceArray<Subscription> implements Disposable {
    ...
    public boolean setResource(int index, Subscription resource) {
        for (;;) {
            ...
            if (o == io.reactivex.internal.subscriptions.SubscriptionHelper.CANCELLED) {
                if (resource != null) {
                    resource.cancel();
                }
                return false;
    ...
    public void dispose() {
        if (get(0) != io.reactivex.internal.subscriptions.SubscriptionHelper.CANCELLED) {
            ...
            for (int i = 0; i < s; i++) {
                ...
                if (o != io.reactivex.internal.subscriptions.SubscriptionHelper.CANCELLED) {
                    o = getAndSet(i, io.reactivex.internal.subscriptions.SubscriptionHelper.CANCELLED);
                    if (o != io.reactivex.internal.subscriptions.SubscriptionHelper.CANCELLED && o != null) {
                        o.cancel();
                    }
                }
            }
