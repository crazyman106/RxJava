...
import rxjava.fengzi.com.rxjava.rxjava.io.reactivex.exceptions.*;
import rxjava.fengzi.com.rxjava.rxjava.io.reactivex.internal.disposables.DisposableContainer;
import rxjava.fengzi.com.rxjava.rxjava.io.reactivex.internal.functions.ObjectHelper;
import rxjava.fengzi.com.rxjava.rxjava.io.reactivex.internal.util.*;
...
public final class CompositeDisposable implements Disposable, DisposableContainer {
    ...
    OpenHashSet<rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable> resources;
     ...
     */
    public CompositeDisposable(@NonNull rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable... disposables) {
        ObjectHelper.requireNonNull(disposables, "disposables is null");
        this.resources = new OpenHashSet<rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable>(disposables.length + 1);
        for (rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable d : disposables) {
     ...
     */
    public CompositeDisposable(@NonNull Iterable<? extends rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable> disposables) {
        ObjectHelper.requireNonNull(disposables, "disposables is null");
        this.resources = new OpenHashSet<rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable>();
        for (rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable d : disposables) {
    ...
    public void dispose() {
        ...
        OpenHashSet<rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable> set;
        synchronized (this) {
            if (disposed) {
                return;
            }
    ...
    public boolean add(@NonNull Disposable disposable) {
        ...
        if (!disposed) {
            synchronized (this) {
                if (!disposed) {
                    OpenHashSet<rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable> set = resources;
                    if (set == null) {
                        set = new OpenHashSet<rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable>();
                        resources = set;
                    }
                    set.add(disposable);
                    return true;
     ...
     * @throws NullPointerException if {@code disposables} or any of its array items is null
     */
    public boolean addAll(@NonNull rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable... disposables) {
        ObjectHelper.requireNonNull(disposables, "disposables is null");
        if (!disposed) {
            synchronized (this) {
                if (!disposed) {
                    OpenHashSet<rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable> set = resources;
                    if (set == null) {
                        set = new OpenHashSet<rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable>(disposables.length + 1);
                        resources = set;
                    }
                    for (rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable d : disposables) {
                        ObjectHelper.requireNonNull(d, "A Disposable in the disposables array is null");
     ...
     */
    void dispose(OpenHashSet<rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable> set) {
        if (set == null) {
            return;
        }
        ...
        for (Object o : array) {
            if (o instanceof rxjava.fengzi.com.rxjava.rxjava.io.reactivex.disposables.Disposable) {
                try {
