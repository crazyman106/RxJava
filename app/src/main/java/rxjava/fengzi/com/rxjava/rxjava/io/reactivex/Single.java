...
public abstract class Single<T> implements SingleSource<T> {
     ...
     * {@link io.reactivex.Maybe} source.
     * <p>
    ...
    @SchedulerSupport(SchedulerSupport.NONE)
    @Experimental
    public final <R> io.reactivex.Maybe<R> dematerialize(Function<? super T, Notification<R>> selector) {
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public final io.reactivex.Maybe<T> filter(Predicate<? super T> predicate) {
    ...
    @NonNull
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> io.reactivex.Maybe<R> flatMapMaybe(final Function<? super T, ? extends MaybeSource<? extends R>> mapper) {
        ObjectHelper.requireNonNull(mapper, "mapper is null");
    ...
    /**
     * Converts this Single into a {@link io.reactivex.Maybe}.
     * <p>
     ...
     * </dl>
     *
     * @return a {@link io.reactivex.Maybe} that emits a single item T or an error.
     */
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    @SuppressWarnings("unchecked")
