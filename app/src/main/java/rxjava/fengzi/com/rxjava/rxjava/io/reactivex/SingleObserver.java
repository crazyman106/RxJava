 ...
 * <p>
 * When a {@code SingleObserver} is subscribed to a {@link io.reactivex.SingleSource} through the {@link SingleSource#subscribe(SingleObserver)} method,
...
public interface SingleObserver<T> {
    ...
    /**
     * Notifies the SingleObserver with a single item and that the {@link io.reactivex.Single} has finished sending
     * push-based notifications.
     * <p>
     * The {@link io.reactivex.Single} will not call this method if it calls {@link #onError}.
     *
     * @param t
    ...
    /**
     * Notifies the SingleObserver that the {@link io.reactivex.Single} has experienced an error condition.
     * <p>
