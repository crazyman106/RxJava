 ...
 * <p>
 * When a {@code CompletableObserver} is subscribed to a {@link io.reactivex.CompletableSource} through the {@link CompletableSource#subscribe(CompletableObserver)} method,
