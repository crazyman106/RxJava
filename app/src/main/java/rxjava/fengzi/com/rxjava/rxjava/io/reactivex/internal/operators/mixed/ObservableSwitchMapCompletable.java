...
package rxjava.fengzi.com.rxjava.rxjava.io.reactivex.internal.operators.mixed;
...
public final class ObservableSwitchMapCompletable<T> extends Completable {
    ...
    protected void subscribeActual(CompletableObserver observer) {
        if (!io.reactivex.internal.operators.mixed.ScalarXMapZHelper.tryAsCompletable(source, mapper, observer)) {
